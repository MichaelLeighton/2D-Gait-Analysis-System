...
process_frame <- function(frame_path, target_size = 100, marker_size = 10, verbose = FALSE) {
  ...
  special_frames <- list(
    # "frames" = blur
    "94" = 0.33, "95" = 0.31, "448" = 0.33, "449" = 0.33, "563" = 0.35
  )
...
output_dir <- "output_directory_S2_5_5_limp"
dir.create(output_dir, showWarnings = FALSE)

# Set up parameters
video_path <- "S2_5_5_limp.MOV"
